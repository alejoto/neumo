...
$sql    = "SELECT 
main_eval.t_st
,hap_reuma_citrul.citrul_date
,hap_reuma_citrul.citrul_a_citrul
,main_patient.name
,main_patient.surn
,main_investigator.ivt_name
,main_investigator.ivt_surname
FROM hap_reuma_citrul LEFT JOIN  main_eval ON  main_eval.eval_id = hap_arterialgasses.eval_id
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th class="span2">citrul_date</th>
                <th class="span2">citrul_a_citrul</th>                
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            ?>
                <tr>
                    ...
                    <td class="span2"><?php echo $row['citrul_date']; ?></td>
                    <td class="span2"><?php echo $row['citrul_a_citrul']; ?></td>                    
                </tr>
            <?php
            }
            ?>
