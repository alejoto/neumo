<div id="hb_and_others">
  ...
  <div class="row">
    <div class="span1">Fecha</div>
    <div class="span3">
      <input type="text" id="y_vih" class="span1 vih date1" name="hiv_date" placeholder="a&ntilde;o" />
      <input type="text" id="m_vih" class="span1 vih" placeholder="mes" />
      <input type="text" id="d_vih" class="span1 vih" placeholder="d&iacute;a" />
    </div>
  </div>
  <div class="row">
