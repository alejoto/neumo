  ...
  <div id="modal_help" class="modal hide fade sign_up" tabindex="-1" role="dialog" style="width: 600px;" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
    	<p>Los campos requeridos se mostraran con fondo azul como el siguiente campo</p>
    	<img alt="" src="../../assets/images/help/required.PNG">
		<hr>    
    	<p>El boton guardar sera visible cuando llene todos los campos obligatorios (con fondo azul) del formulario</p>
    	<img alt="" src="../../assets/images/help/save.gif">
    	<hr>
    	...
    	<img alt="" src="../../assets/images/help/popup.gif">
    	<hr>
    	...
    	<img alt="" src="../../assets/images/help/tooltip.gif">
    	<hr>
      	...
      	<img alt="" src="../../assets/images/help/date.gif">
      	<hr>
