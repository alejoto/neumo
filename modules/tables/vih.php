...
FROM hap_vih LEFT JOIN  main_eval ON  main_eval.eval_id = hap_arterialgasses.eval_id
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th class="span2">hiv_date</th>
                <th class="span2">hiv_result</th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="span2"><?php echo $row['hiv_date']; ?></td>
                    <td class="span2"><?php echo $row['hiv_result']; ?></td>
