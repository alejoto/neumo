...
$sql    = "SELECT 
main_eval.t_st
,hap_reuma_spana.spana_date
,hap_reuma_spana.spana_ctmere
,hap_reuma_spana.spana_anti_rna
,hap_reuma_spana.spana_anti_dna
,main_patient.name
,main_patient.surn
,main_investigator.ivt_name
,main_investigator.ivt_surname
FROM hap_reuma_spana LEFT JOIN  main_eval ON  main_eval.eval_id = hap_arterialgasses.eval_id
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th class="span2">spana_date</th>
                <th class="span2">spana_ctmere</th>
                <th class="span2">spana_anti_rna</th>                
                <th class="span2">spana_anti_dna</th>                
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            ?>
                <tr>
                    ...
                    <td class="span2"><?php echo $row['spana_date']; ?></td>
                    <td class="span2"><?php echo $row['spana_ctmere']; ?></td>
                    <td class="span2"><?php echo $row['spana_anti_rna']; ?></td>                    
                    <td class="span2"><?php echo $row['spana_anti_dna']; ?></td>                    
                </tr>
            <?php
            }
            ?>
