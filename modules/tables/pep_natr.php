...
$sql    = "SELECT 
main_eval.t_st
,hap_pep_natr.pep_natr_date
,hap_pep_natr.pep_natr_value
,main_patient.name
,main_patient.surn
,main_investigator.ivt_name
,main_investigator.ivt_surname
FROM hap_pep_natr LEFT JOIN  main_eval ON  main_eval.eval_id = hap_arterialgasses.eval_id
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th class="span2">pep_natr_date</th>
                <th class="span2">pep_natr_value</th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="span2"><?php echo $row['pep_natr_date']; ?></td>
                    <td class="span2"><?php echo $row['pep_natr_value']; ?></td>
