...
$sql    = "SELECT 
main_eval.t_st
,hap_surgical.surgical_date
,hap_surgical.surgical_type
,hap_surgical.surgical_tendt_date
,hap_surgical.surgical_atr_date
,main_patient.name
,main_patient.surn
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th class="span2">surgical_date</th>
                <th class="span2">surgical_type</th>
                <th class="span2">surgical_tendt_date</th>
                <th class="span2">surgical_atr_date</th>                
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            ?>
                <tr>
                    ...
                    <td class="span2"><?php echo $row['surgical_date']; ?></td>
                    <td class="span2"><?php echo $row['surgical_type']; ?></td>
                    <td class="span2"><?php echo $row['surgical_tendt_date']; ?></td>
                    <td class="span2"><?php echo $row['surgical_atr_date']; ?></td>                    
                </tr>
            <?php
            }
            ?>
