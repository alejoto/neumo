<div id="hb_and_others">
  ...
  <div class="row">
    <div class="span8"> <b>HEMOGLOBINA (mg/dL)</b>
  ...
  <div class="row">
    ...
    <div class="span1">
      <input type="text" id="tsh" class="span1" placeholder="mIU/mL" />
    </div>
    <div class="span1" style="text-align:right">T4 total</div>
    <div class="span2">
      <input type="text" id="t_4_total" class="span1" placeholder="mcg/dL" />
    </div>
  </div>
  <div class="row">
    ...
    <div class="span2">
      <input type="text" id="t_4_free" class="span1" placeholder="ng/dL" />
    </div>
  ...
  <div class="row">
    ...
    <div class="span2">
      <input type="text" id="pep_natr_value" class="span1" placeholder="pg/mL"
      />
    </div>
    <div class="span1">Pro-BNP</div>
    <div class="span1">
      <input type="text" id="pro_pep_natr_value" class="span1" placeholder="pg/mL"
      />
    </div>
  ...
  <div class="row">
    ...
    <div class="offset2 span1"> <a class="btn" id="hiv_save">Guardar</a>
