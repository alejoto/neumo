...
,hap_arterialgasses.bld_gass_date
,hap_arterialgasses.bld_gass_fio2
,hap_arterialgasses.bld_gass_ph
,hap_arterialgasses.bld_gass_paco2
,hap_arterialgasses.bld_gass_pao2
,hap_arterialgasses.bld_gass_hco3
...
FROM hap_arterialgasses LEFT JOIN  main_eval ON  main_eval.eval_id = hap_arterialgasses.eval_id
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="span2"><?php echo $row['bld_gass_date']; ?></td>
                    <td class="span2"><?php echo $row['bld_gass_fio2']; ?></td>
                    <td class="span2"><?php echo $row['bld_gass_ph']; ?></td>
                    <td class="span2"><?php echo $row['bld_gass_paco2']; ?></td>
                    <td class="span2"><?php echo $row['bld_gass_pao2']; ?></td>
                    <td class="span2"><?php echo $row['bld_gass_hco3']; ?></td>
                </tr>
            <?php
            }
            ?>
