  ...
  <div class="row">
    ...
    <div class="span3" style="margin-top: 0px;">
      ...
      <div style="margin-left: 13px;">
        ...
        <a class="btn span3" id="showbas">Datos basales</a>
        <a class="btn span3" id="showrt" >Test vasorreactividad</a>
      </div>
    ...
    <div class="span9" style="margin-top: 40px;">
      ...
      <div class="row">
                            <div id="basal">
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="control-group"><label class="control-label" for="res_vasc_syst">Res. vasc.sist&eacute;mica</label>
                                        <div class="controls"><input type="text" id="res_vasc_syst" placeholder="res. vsc. sist&eacute;mica"  class="span2">
                                    ...
                                    <div class="control-group"><label class="control-label" for="pap_sys">Pres. arterial <b>pulmonar</b></label>
                                        <div class="controls"><input type="text" id="pap_sys" placeholder="sist&oacute;l." class="span1">
                                            <input type="text" id="pap_dias" placeholder="diast&oacute;l." class="span1"><b><span id="pam_pulm"></span></b>
                                        </div>
                                    </div>
                                    <div class="control-group"><label class="control-label" for="pas_sys">Pres. arterial <b>sist&eacute;mica</b></label>
                                        <div class="controls"><input type="text" id="pas_sys" placeholder="sist&oacute;l." class="span1">
                                            <input type="text" id="pas_dias" placeholder="diast&oacute;l." class="span1"><b><span id="pam_stm"></span></b>
                                        </div>
                                    </div>
                                  <div class="control-group"><label class="control-label" for="rt_atr_press">Pres aur&iacute;cula derecha</label>
                                    ...
                                    <div class="control-group"><label class="control-label" for="pulm_wedg_press">Pres. cu&ntilde;a pulmonar</label>
                                        <div class="controls">
                                            <div class="input-append">
                            ...
                            <div id="reactiv">
                                <div CLASS="well well-small">
                                    <h5>TEST DE VASOREACTIVIDAD </h5></div>
                                <div class="spam8">
                                    Fecha examen:
                                    <input type="text" id="year2" placeholder="A&ntilde;o" class="span1">
                                    <input type="text" id="month2" placeholder="Mes" class="span1">
                                    <input type="text" id="day2" placeholder="D&iacute;a" class="span1">
                                </div>
                                <form class="form-horizontal">
                                    <div class="control-group"><label class="control-label" for="test_drug"></label><div class="controls"><div class="input-append">
                                        <select id="test_drug">
                                            ...
                                            <option value="ox_nitrico">Óxido n&iacute;trico</option>
                                ...
                                <div id="drugdependant">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="control-group"><label class="control-label" for="post_pap_sys">Pres. Arterial <b>Pulmonar</b></label>
                                            <div class="controls"><input type="text" id="post_pap_sys" placeholder="sist&oacute;lica" class="span1">
                                                <input type="text" id="post_pap_dias" placeholder="diast&oacute;lica" class="span1">
                                        ...
                                        <div class="control-group"><label class="control-label" for="post_pas_sys">Pres. Arterial <b>Sist&eacute;mica</b></label>
                                            <div class="controls">
                                                <input type="text" id="post_pas_sys" placeholder="sist&oacute;lica" class="span1">
                                                <input type="text" id="post_pas_dias" placeholder="diast&oacute;lica" class="span1">
                                        ...
                                        <div class="control-group"><label class="control-label" for="post_pulm_wedg_press">Pres. cu&ntilde;a pulmonar</label>
                                            <div class="controls">
                                                <div class="input-append">
