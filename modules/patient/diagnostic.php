  ...
  <div class="row">
    ...
    <div class="span3" style="margin-top: 0px;">
      ...
      <div style="margin-left: 13px;">
        <h3 id="left_title">Imágenes diagnósticas</h3>
        <a class="btn span2" id="sel_ecocardio">Ecocardiografía</a>
        <a class="btn span2" id="sel_x_ray">Rayos X</a>
        <a class="btn span2" id="sel_tc_angio">Tomografía</a>
        <a class="btn span2" id="sel_mri">Resonancia</a>
        <a class="btn span2" id="sel_pulm_arteriography">Arteriografía p</a>
        <a class="btn span2" id="sel_gammagr">Gamagrafía V/P</a>
