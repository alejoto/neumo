...
$sql    = "SELECT 
main_eval.t_st
,hap_reuma_ana.ana_date
,hap_reuma_ana.ana_result
,main_patient.name
,main_patient.surn
,main_investigator.ivt_name
,main_investigator.ivt_surname
FROM hap_reuma_ana LEFT JOIN  main_eval ON  main_eval.eval_id = hap_arterialgasses.eval_id
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th class="span2">ana_date</th>
                <th class="span2">ana_result</th>                
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            ?>
                <tr>
                    ...
                    <td class="span2"><?php echo $row['ana_date']; ?></td>
                    <td class="span2"><?php echo $row['ana_result']; ?></td>                    
                </tr>
            <?php
            }
            ?>
